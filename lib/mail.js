...
const genarateHtml=({name,trxId,amount,senderName,dateTime})=>{
  return `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
const sendTransactionEmail = async ({to,amount=0,trxId="",datetime="",senderName="unknown",recivername="user"}) => {
  const mailOptions = {
